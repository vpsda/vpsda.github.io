...
当然，有钱就能任性，钱管够香港vps还是很香的，钱不够的同学请参考上面我的建议。<a rel="noopener" href="https://linkv.org/bwhk/" target="_blank">搬瓦工的香港VPS</a>，除了价格贵没什么大的缺点，预算充足可以考虑。如果是建网站，优先考虑美国VPS,便宜量大，国外访问速度快。
